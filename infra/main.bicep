...
@metadata({azd: {
  type: 'location'
  usageName: 'OpenAI.GlobalStandard.gpt-4o-mini,10'
  }
})
...
output AZURE_RESOURCE_LOAD_IT_ID string = resources.outputs.AZURE_RESOURCE_LOAD_IT_ID
